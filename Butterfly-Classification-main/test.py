...
print(torch.cuda.is_available())  # Kiểm tra xem CUDA có hoạt động không
print(torch.cuda.device_count())  # Số GPU có thể sử dụng
...
def main():
    ...
    test_dir = r"D:\download\Butterfly-Classification-main\dataset\dataset\Test"  # Directly point to Test folder
    num_classes = 75
